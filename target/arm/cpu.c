...
static const ARMCPRegInfo cortexa78_cp_reginfo[] = {
    { .name = "ERRSELR_EL1", .cp = 15, .crn = 5, .crm = 3, .opc1 = 0, .opc2 = 1,
      .access = PL1_RW, .readfn = arm_cp_read_zero,
      .writefn = arm_cp_write_ignore, },
    { .name = "ERXCTLR_EL1", .cp = 15, .crn = 5, .crm = 4, .opc1 = 0, .opc2 = 1,
      .access = PL1_RW, .readfn = arm_cp_read_zero,
      .writefn = arm_cp_write_ignore, },
    { .name = "CPUACTLR",
      .cp = 15, .opc1 = 0, .crm = 15,
...
static void cortex_a78_initfn(Object *obj)
{
    ARMCPU *cpu = ARM_CPU(obj);
    ...
    cpu->ccsidr[1] = 0x201fe00a; /* 32K L1 icache */
    cpu->ccsidr[2] = 0x711fe07a; /* 4096K L2 unified cache */
    define_arm_cp_regs(cpu, cortexa78_cp_reginfo);
}
...
static const ARMCPUInfo arm_cpus[] = {
    ...
    { .name = "cortex-a78",  .initfn = cortex_a78_initfn },
